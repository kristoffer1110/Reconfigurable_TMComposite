...
#
# tmc.tcl: Tcl script for re-creating project 'TMC_block'
#
# Generated by Vivado on Mon May 18 12:33:43 +0200 2026
...
#
# 1. This project restoration tcl script (tmc.tcl) that was generated.
#
# 2. The following source(s) files that were local or imported into the original project.
#    (Please see the '$orig_proj_dir' and '$origin_dir' variable setting below at the start of the script)
#
#    "C:/Xilinx/projects/TMC_block/TMC_block.srcs/sources_1/bd/tmc/tmc.bd"
#    "C:/Xilinx/projects/TMC_block/TMC_block.srcs/utils_1/imports/synth_1/tmc_wrapper.dcp"
#
...
proc checkRequiredFiles { origin_dir} {
  set status true
  set files [list \
 "[file normalize "$origin_dir/../../TMC_block/TMC_block.srcs/sources_1/bd/tmc/tmc.bd"]"\
 "[file normalize "$origin_dir/../../TMC_block/TMC_block.srcs/utils_1/imports/synth_1/tmc_wrapper.dcp"]"\
  ]
  foreach ifile $files {
  ...
  set paths [list \
 "[file normalize "$origin_dir/../../../../Users/kgab/AppData/Roaming/Xilinx/Vivado/"]"]"\
  ]
  foreach ipath $paths {
...
set orig_proj_dir "[file normalize "$origin_dir/../../TMC_block"]"
...
if { [get_property IS_LOCKED [ get_files -norecurse tmc.bd] ] == 1  } {
  import_files -fileset sources_1 [file normalize "${origin_dir}/../../TMC_block/TMC_block.gen/sources_1/bd/tmc/hdl/tmc_wrapper.vhd" ]
} else {
  set wrapper_path [make_wrapper -fileset sources_1 -files [ get_files -norecurse tmc.bd] -top]
...
set_property -name "top" -value "tmc_wrapper" -objects $obj
...
set file "synth_1/tmc_wrapper.dcp"
...
set_property -name "incremental_checkpoint" -value "$proj_dir/${_xil_proj_name_}.srcs/utils_1/imports/synth_1/tmc_wrapper.dcp" -objects $obj
