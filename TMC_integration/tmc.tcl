...
#
# tmc.tcl: Tcl script for re-creating project 'TMC_integration'
#
# Generated by Vivado on Wed May 20 13:51:22 +0200 2026
...
#
#    "C:/Xilinx/projects/TMC_integration/TMC_integration.srcs/sources_1/bd/design_1/design_1.bd"
#
...
proc checkRequiredFiles { origin_dir} {
  set status true
  set files [list \
 "[file normalize "$origin_dir/TMC_integration.srcs/sources_1/bd/design_1/design_1.bd"]"\
  ]
  foreach ifile $files {
  ...
  set paths [list \
 "[file normalize "$origin_dir/../../../Users/kgab/AppData/Roaming/Xilinx/Vivado/IP"]"]"\
  ]
  foreach ipath $paths {
...
set _xil_proj_name_ "TMC_integration"
...
if { [get_property IS_LOCKED [ get_files -norecurse design_1.bd] ] == 1  } {
  import_files -fileset sources_1 [file normalize "${origin_dir}/TMC_integration.gen/sources_1/bd/design_1/hdl/design_1_wrapper.vhd" ]
} else {
